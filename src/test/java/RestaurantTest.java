...
class RestaurantTest {
    ...
    public void is_restaurant_open_should_return_true_if_time_is_between_opening_and_closing_time(){
        ...
        restaurant.setRestaurantCloseTime(LocalTime.now().plusHours(1)); // to test ClosingTime with (22:00 + 1 Hrs)
    ...
    public void is_restaurant_open_should_return_false_if_time_is_outside_opening_and_closing_time(){
        ...
        //restaurant.setRestaurantCloseTime(LocalTime.parse("18:25:00")); // to test ClosingTime with (22:00 - desired Time)
        restaurant.setRestaurantCloseTime(LocalTime.now().minusMinutes(30));
